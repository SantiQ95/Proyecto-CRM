...
def main():
    while True:
        ...
        if opcion == "1":
            ...
            from controllers import factura_controller, reportes_controller
            factura = factura_controller.crear_factura()
            # If a factura was created, show the financial summary
            # This is useful to immediately see the impact of the new invoice.
            if factura:
